	...
	<form class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="number" class="form-control" id="number" placeholder="<?= Lang::get('admin.form.placeholders.episode.number') ?>" ng-model="episode.number">
			</div>
			<div class="form-group">
...
<div class="modal-footer">
	<button class="btn btn-primary" ng-click="storeEpisode()"><?php echo Lang::get('admin.modal.edit_media.save'); ?></button>
