...
EvoSlider.prototype = {
    ...
    unbindClicker: function(tabIndex){
         this._titles.eq( tabIndex ).unbind();
    },

    bindClicker: function(tabIndex){
         this._titles.eq( tabIndex ).bind("click.es", {evo: this, index: tabIndex}, this._titleClickHandler);
    } 
};
...
$.fn.evoSlider.options = {
    ...
    speed: 300,                         // Slide transition speed in ms. (1s = 1000ms)
